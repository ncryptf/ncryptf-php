...
JSON;
        ...
        $cipher = $request->encrypt($payload, \base64_decode($this->signatureKeyPair['secret']), 2, \base64_decode($this->nonce));
...
JSON;
        ...
        $cipher = $request->encrypt($payload, null, 1, \base64_decode($this->nonce));
